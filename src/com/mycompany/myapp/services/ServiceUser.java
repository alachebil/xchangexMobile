...
public class ServiceUser {
    ...
    public boolean addUser(User u) {       
        String url = Statics.BASE_URL + "/addUserJSON/new?nom=" + u.getNom() + "&prenom=" + u.getPrenom()+ "&id=" + u.getId() + "&numtel=" + u.getNumTel()+ "&adresse=" + u.getAdresse() + "&email=" + u.getEmail() + "&role=\"[\"ROLE_USER\"]" + "&password=" + u.getPassword();
        req.setUrl(url);
        req.setPost(false);
