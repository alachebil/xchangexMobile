...
public class ServiceEvenement {
    ...
    public boolean addEvenement(evenement e) {
        String url = Statics.BASE_URL +"/evenement/Addjson?" + "nomEvent=" + e.getNom_event()+ "&typeEvent=" + e.getType_event() + "&descriptionEvent=" + e.getDescription_event();
        req.setUrl(url); 
        req.setPost(false);
...
public ArrayList<evenement> parseAnnonces(String jsonText) throws ParseException {
    ...
    try {
        ...
        for (Map<String, Object> obj : list) {
            ...
            int idf = (int) Float.parseFloat(obj.get("idEvent").toString());
            a.setId_event(idf);
            a.setNom_event(obj.get("nomEvent").toString());
            System.out.println(obj.get("typeEvent").toString());
...
String url = Statics.BASE_URL + "/evenement/updateEventJSON/" + e.getId_event()+ "?nomEvent=" + e.getNom_event()+ "&typeEvent=" + e.getType_event() + "&descriptionEvent=" + e.getDescription_event() ;
       // req.setUrl(url);
    req.setUrl(url);
